...
BLOG_AUTHOR = "Karim Norman Gorjux"  # (translatable)
BLOG_TITLE = "Australia Facile"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.australiafacile.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.australiafacile.com/"
BLOG_EMAIL = "karimone@gmail.com"
BLOG_DESCRIPTION = "Il sito ufficiale del gruppo facebook"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "australiafacile"
